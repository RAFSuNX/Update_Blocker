...
# binaries to null out) lives in devices.json next to this script, keyed as
# "<codename>-<android release version>" (e.g. "panther-14"), since the
# right packages/paths can change across OS versions on the same hardware.
# Unlisted combinations are NOT supported — customize.sh aborts install
# rather than guessing. Add your device+version to devices.json and open a
# PR.
